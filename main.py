        ...
        for issue in issues:
            ...
            if existing:
                ...
                has_changes = (
                    ...
                    existing.sprint_end_time != issue.sprint_end_time or
...
def _build_things_task_data(ticket: JiraTicket, config: dict, today_status: set, someday_status: set, completed_status: set, jira_base_url: str):
    ...
    # notes = f"{jira_url}\n\n{ticket.description}" # I just want a markdown link to the jira item, not the description. TODO: Create config option later
    ...
    project = ticket.things_project or config.get('THINGS_PROJECT', '')
